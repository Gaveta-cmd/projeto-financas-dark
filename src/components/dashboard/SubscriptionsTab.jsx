        ...
        {modalOpen && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-2xl bg-white dark:bg-black rounded-3xl p-6 md:p-8 relative max-h-[90vh] overflow-y-auto border border-gray-200 dark:border-transparent"
              onClick={e => e.stopPropagation()}
            >
              {/* Close */}
              <button
                onClick={() => setModalOpen(false)}
                className="absolute top-5 right-5 w-8 h-8 flex items-center justify-center rounded-full text-gray-500 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/10 transition-colors"
              >
                <X className="w-4 h-4" />
              </button>
              ...
              <div className="flex items-center justify-center gap-3 mb-8">
                ...
                <button
                  ...
                  className={`relative w-11 h-6 rounded-full transition-colors duration-200 ${
                    billing === 'annual' ? 'bg-accent' : 'bg-gray-200 dark:bg-zinc-700'
                  }`}
                >
                  <motion.span
                  ...
                  return (
                    <div
                      ...
                      className={`relative rounded-2xl p-6 border flex flex-col ${
                        badge
                          ? 'border-accent/50 bg-gray-50 dark:bg-zinc-950'
                          : 'border-gray-200 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-950'
                      }`}
                    >
                      {/* Popular badge */}
                      {badge && (
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="text-gray-900 dark:text-white font-bold text-lg">{name}</span>
                      </div>
